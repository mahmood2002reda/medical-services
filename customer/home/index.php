...
<div class="col-sm-12">
        <h3 class="text-center p-3 bg-primary text-white">Latest messages</h3>
        <table class="table table-dark table-bordered">
            ...
            <tbody>
                <?php 
                 ...
                 $userMsgSql = "SELECT * FROM `doctor_user_messages` dum INNER JOIN doctors d ON dum.doctor_id = d.doctor_id WHERE `user_id` = '$user_id' AND `status` <> 'replied' AND `sender` = 'doctor' LIMIT 5 ";
