...
<div class="col-sm-12">
        <h3 class="text-center p-3 bg-primary text-white">Latest Orders</h3>
        <table class="table table-dark table-bordered">
            ...
            <tbody>
                ...
                <?php while($row = mysqli_fetch_assoc($doctorObject)){   ?>
                    ...
                    <a href="../order/reply.php?user_id=<?= $row['user_id']; ?>&order_id=<?= $row['orders_id'] ?>" class="btn btn-success">Contact</a>
                    <a href="../order/delete.php?order_id=<?= $row['orders_id'] ?>" class="btn btn-danger " >Decline</a>
                    </td>
